...
# hardware.
#
# The Pmod JA/JB and Arduino sections are commented out: pico_bit.tcl creates
# those BD interface ports but connects nothing to them, so the generated
# design_1_wrapper drops them and every constraint there raised
# CRITICAL WARNING [Common 17-55]. Uncomment a section once logic is wired
